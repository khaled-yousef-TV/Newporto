...
export default function Hero() {
  return (
    <section className="h-screen flex flex-col justify-center items-center px-6 md:px-10 relative overflow-hidden bg-background">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-pastel-purple/20 via-background to-background opacity-70" />
      ...
      <div className="flex flex-col items-center text-center space-y-4 md:space-y-8 z-10">
        ...
        >
          Creativity <br />
          <span className="font-light italic text-pastel-purple">is my craft</span>
        </motion.h1>
